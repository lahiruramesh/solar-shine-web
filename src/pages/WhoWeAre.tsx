      ...
      <main className="pt-20 min-h-screen">
        ...
        <section className="relative h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            <img 
              src={whoWeAreData.heroSection.image} 
              alt="Solar team" 
              className="w-full h-full object-cover"
            />
          </div>
          <div className="container-custom relative z-20 text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">{whoWeAreData.heroSection.title}</h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              {whoWeAreData.heroSection.subtitle}
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="container-custom">
            <div className="grid md:grid-cols-2 gap-10">
              ...
              >
                <h2 className="text-3xl font-bold mb-4">{whoWeAreData.mission.title}</h2>
                <p className="text-lg text-brand-gray">{whoWeAreData.mission.description}</p>
              </motion.div>
              ...
              >
                <h2 className="text-3xl font-bold mb-4">{whoWeAreData.vision.title}</h2>
                <p className="text-lg text-brand-black/80">{whoWeAreData.vision.description}</p>
              </motion.div>
            </div>
          </div>
        </section>
